...
export const CardUserSkills = ({ pulicacao, id }) => {
  ...
  function handleSubmitDelete() {
    api
      .delete(`/api/skills/${pulicacao.id}`)
      .then((res) => {
        console.log(res);
      })
      .catch((error) => {
  ...
  function handleUserSkillSubmitDelete() {
    api
      .delete(`/api/userSkills/${pulicacao.id}`)
      .then((res) => {
        console.log(res);
      })
      .catch((error) => {
  ...
  return (
    <ContainerLogin>
      <Card>
        ...
        >
          <h8 style={{ fontWeight: "bold", color: "#858597" }}>Nome:</h8>
        ...
        >
          <h8 style={{ fontWeight: "bold", color: "#858597" }}>Descrição:</h8>
          <h8 style={{ fontWeight: "bold", color: "#858597" }}>
            {/* {pulicacao.knowledgeLevel} */}
